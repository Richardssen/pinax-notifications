    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'send',
                    models.BooleanField(default=False, verbose_name='send'),
                ),
                (
                    'scoping_object_id',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'label',
                    models.CharField(max_length=40, verbose_name='label'),
                ),
                (
                    'display',
                    models.CharField(max_length=50, verbose_name='display'),
                ),
                (
                    'description',
                    models.CharField(
